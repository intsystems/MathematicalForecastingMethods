...
\begin{frame}{Регрессионные модели: автокорреляция}
	...
	\end{figure}
	\myfootnotewithlink{https://www.researchgate.net/publication/345125392_Data-Driven_Anomaly_Detection_Approach_for_Time-Series_Streaming_Data?_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6Il9kaXJlY3QiLCJwYWdlIjoiX2RpcmVjdCJ9fQ}{сredit: https://www.researchgate.net/publication/345125392}
\end{frame}
%=======
...
\begin{frame}{Регрессионные модели: сверточные нейронные сети}
	...
	\end{figure}
	\myfootnotewithlink{https://www.researchgate.net/figure/One-dimensional-Convolutional-Neural-Network-for-time-series_fig5_350457058}{сredit: https://www.researchgate.net/figure/One-dimensional-Convolutional-Neural-Network-for-time-series}
\end{frame}
%=======
...
\end{frame}
%=======
\begin{frame}{От статистических к динамическим: перекрёстное отображение}
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{lecture_1/figs/ssm.png}
	\end{figure}
	\myfootnotewithlink{https://phdinds-aim.github.io/time_series_handbook/06_ConvergentCrossMappingandSugiharaCausality/ccm_sugihara.html}{сredit: https://phdinds-aim.github.io/time\_series\_handbook}
\end{frame}
%=======
\begin{frame}{От статистических к динамическим: анализ Фурье}
	\begin{figure}
		\centering
...
\end{frame}
%=======
\begin{frame}{От статистических к динамическим: вейвлет преобразование}
	\begin{figure}
		\centering
...
\begin{itemize}
    ...
    % $t_i = t_0 + (i - 1)\tau : x_i = x(t_i), i = 1,..., N$.
